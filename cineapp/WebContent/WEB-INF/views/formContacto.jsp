		...
		<form:form class="form-horizontal" action="${urlRoot}contacto"
			...
			<div class="form-group">
				<label for="genero" class="col-sm-2 control-label">Géneros
					Favoritos</label>
				<div class="col-sm-10">
					<!--Al form select se le puede añadir los atributos itemValue="id" que hace que el valore devuelto corresponda con el id del obejto propio -->
					<!--o itemLabel que es el contenido que aparecerá en la vista -->
